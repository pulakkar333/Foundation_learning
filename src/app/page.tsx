    ...
    <div className="bg-white w-auto h-auto min-h-screen flex flex-col">
      ...
      >
        <div className="relative w-full h-screen">
          <button
            className="absolute bottom-4 right-4 flex items-center justify-center w-[124px] h-[40px] flex-shrink-0 rounded-[100px] border border-[#FFCFA4] bg-[#FDF0E4] text-sm font-medium"
            style={{
