      ...
      <div className="ssm:mt-[150px] md:mt-[150px] xl:mt-[100px] ">
        <div className="flex flex-col md:flex-row xl:justify-between border-l border-[#2F58521A] sm:border-[#2F58521A] md:border-none lg:border-none">
          ...
          <div className="w-auto xl:border-l md:border-l lg:border-l md:pl-[20px] md:pr-[20px] md:mt-0 py-4 order-2 md:order-1 border-[#2F58521A] ssm:border-t ssm:border-b md:border-0 xl:border-0 ssm:px-[16px]">
            <div className="border-[#2F58521A] pb-2 flex xl:space-x-[80px] md:space-x-[20px] ssm:space-x-[120px] w-full lg:w-[250px] xl:border-b md:border-b ">
          ...
          <div className="w-full xl:w-1/3 md:border-l border-[#2F58521A] md:pl-[20px] py-4 order-3 md:order-2 xl:mr-[300px] xl:ml-[10px] ssm:px-[16px] ssm:order-1 ssm:border-t md:border-t-0 md:ml-0 md:mr-0 relative md:overflow-hidden xl:overflow-visible">
            <button className="px-3 py-2 bg-white text-[#2F5852] rounded-full text-sm font-normal">
              Overview
            </button>
            <ul className="mt-4 space-y-2 text-[#2F5852] text-[16px] font-medium md:flex md:space-y-0 md:flex-col">
            ...
            {/* Updated gradient fade effect with xl:hidden */}
            <div className="absolute inset-y-0 right-0 w-20 bg-gradient-to-l from-[#D6EFF2] to-transparent pointer-events-none ssm:hidden xl:hidden md:block"></div>
          </div>
